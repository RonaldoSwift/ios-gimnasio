//
//  terceraPantallaView.swift
//  ios-gimnasio
//
//  Created by Ronaldo Andre Vargas Huaman on 14/07/22.
//

import SwiftUI

struct terceraPantallaView: View {
    var body: some View {
...
struct terceraPantallaView_Previews: PreviewProvider {
